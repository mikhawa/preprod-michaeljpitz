...
**Stack** : PHP 8.3 / Symfony 7.4 / Doctrine ORM 3.x / Twig 3.x / MariaDB 10.11 / AssetMapper / Tailwind CSS 3.x / Stimulus.js + Turbo / EasyAdmin 4.x / VichUploaderBundle / cropperjs / suneditor / Mailpit (dev) / Mailgun (prod)
...
- Prod → Mailgun (`MAILER_DSN=mailgun+api://KEY:DOMAIN@default?region=eu` dans `.env.local`, non commité)
